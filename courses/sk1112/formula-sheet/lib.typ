...
#let problem(number, body) = {
  block(width: 100%, stroke: kth.colors.blue, inset: 0.5pt, radius: 0pt)[
    // Header
    #block(width: 100%, fill: kth.colors.blue, inset: 10pt, below: 0pt)[
      #text(
...
#let kthblock(title, body) = {
  block(width: 100%, inset: 0pt, radius: 0pt, stroke: kth.colors.blue)[
    // Header
    #block(width: 100%, fill: kth.colors.blue, inset: 10pt, below: 0pt)[
      #text(
        fill: kth.colors.white,
    ...
    #block(width: 100%, fill: kth.colors.sand, inset: 10pt, radius: 0pt, stroke: kth.colors.blue)[
      #text(
        font: kth.fonts.sans,
        size: kth.text-size.body,
        fill: black
